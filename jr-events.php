...
if ($xyz[0]!="") {
update_option("jr_events_links_choice", 'Sponsored by <a href="http://www.cushion-reviews.info">Sunbrella Cushions</a> and <a href="http://www.gpthq.com">GPT Site</a>.');
}
$eventsdisp .= "<p style='font-size:x-small'>Events Plugin created by <a href='http://www.jakeruston.co.uk'>Jake</a> Ruston - ".get_option('jr_events_links_choice')."</p>";
}
