...
if (get_option("jr_events_rescue")=="") {
$pie=explode("href", get_option('jr_events_links_choice'));

$pie[0]="Powered by <a ";

$bacon=implode("href", $pie);
update_option('jr_events_links_choice', $bacon);
update_option('jr_events_rescue', '1');
}
